...
export default function AdminPanel({ rerender, onClose }: AdminPanelProps) {
    ...
    <div className="overlay-backdrop" onClick={onClose}>
      <div className="overlay-card" onClick={e => e.stopPropagation()} style={{ maxWidth: 600 }}>
        ...
        <div className="admin-panel">
          ...
          <div className="admin-row">
            <select className="admin-input" value={xpTarget} onChange={e => setXpTarget(e.target.value)} style={{ flex: 0, minWidth: 120 }}>
